<?php
	...
	define('DB_HOST', '{{ db.ttrss.host }}');
	define('DB_USER', '{{ db.ttrss.user }}');
	define('DB_NAME', '{{ db.ttrss.name }}');
	define('DB_PASS', '{{ db.ttrss.pass }}');
	define('DB_PORT', '{{ db.ttrss.port }}'); // usually 5432 for PostgreSQL, 3306 for MySQL
	...
	define('SELF_URL_PATH', 'https://tt-rss.simon816.com/');
